...
* **Closest Reference Accession**: RefSeq accession for reference hit by BLAST if a blast alignment was detected otherwise NA. The link directs to the corresponding entry in `NCBI <https://www.ncbi.nlm.nih.gov/protein>`_.
