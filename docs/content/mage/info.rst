...
AMRFinder+ is ran with the protein sequences as input using the *"plus"* option and the *"organism"* option. 
...
You can access to the :ref:`AMRFinder+ Result page <amrfinder>` by clicking on  **Resistome** tab in the Comparative Genomics menu.
