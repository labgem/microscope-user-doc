...
You can access to the `AntiSMASH cluster visualization window <https://microscope.readthedocs.io/en/latest/content/mage/domainviewer>`_ from the Cluster column of the antiSMASH annotation table.
