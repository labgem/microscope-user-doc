...
On the `Login Interface of the Navigation Menu <../overview/interface.html>`_ (item #1), near the *welcome guest* message,
...
On your first login, you’ll be redirected to the `Personal Informations Interface <../userpanel/personalinfo.html>`_ where you’ll be prompted to fill in or update required data before using the platform.
...
You can manage your own set of preferred organisms (for exemple, your Project’s specific organisms) in a **Quick Access Menu**, by using the `My Favourite Organisms <../userpanel/favourites.html>`_